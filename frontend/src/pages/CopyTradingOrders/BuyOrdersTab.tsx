...
import type { BuyOrderInfo, OrderTrackingRequest, AccountOrderTrackingRequest, OrderTrackingListResponse, MarketGroupedOrdersRequest, MarketGroupedOrdersResponse, MarketOrderGroup, BridgeTradeRecord, BridgeTradeRecordListResponse } from '../../types'
...
const BuyOrdersTab: React.FC<BuyOrdersTabProps> = ({ copyTradingId, accountId, active = false }) => {
  ...
  useEffect(() => {
    if (!(copyTradingId || accountId) || !active) return
