...
import type { MatchedOrderInfo, OrderTrackingRequest, AccountOrderTrackingRequest, OrderTrackingListResponse, BridgeTradeRecord, BridgeTradeRecordListResponse } from '../../types'
...
const MatchedOrdersTab: React.FC<MatchedOrdersTabProps> = ({ copyTradingId, accountId, active = false }) => {
  ...
  }, [copyTradingId, accountId, active, page, limit])
